...
def assert_quantity_almost_equal(object1, object2):
    assert utils.is_quantity_close(object1, object2), "{} != {}".format(
        object1, object2
    )
...
def test_find_forces():
    ...
    yield assert_forces_equal, found_forces, [
    ...
    def test_restraint_properties(self):
        ...
        for restraint in self.restraints:
            ...
            if isinstance(restraint, RadiallySymmetricCentroidRestraintForce):
                ...
                yield assert_equal, restraint.restrained_atom_indices1, [
                    self.restrained_atom_index1
                ]
                yield assert_equal, restraint.restrained_atom_indices2, [
